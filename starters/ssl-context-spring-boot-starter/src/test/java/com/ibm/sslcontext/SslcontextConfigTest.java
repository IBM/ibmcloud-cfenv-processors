...
class SslcontextConfigTest {
    ...
    public void invalidCert_noSSLContexSetup() {
        Map<String, SslConfigProperties.SSLContext> contexts = new HashMap<>();
        contexts.put("invalidCert", new SslConfigProperties.SSLContext());
