...
class AppIDCfEnvProcessorTest {
    ...
    AppIDCfEnvProcessor userProvidedServiceAppIDCfEnvProcessor = new AppIDCfEnvProcessor();
    ...
    @Test
    public void UserProvidedService_accept_serviceNotAccepted() throws IOException {
        System.setProperty("CFENV_USER_PROVIDED_SERVICE_SEARCH_DISABLE", "true");
        assertThat(userProvidedServiceAppIDCfEnvProcessor.accept(initUserProvidedService())).isFalse();
    }
    ...
    public void validUserProvidedService_propertiesProcessed_CorrectAppIDSetup() throws IOException {
        Map<String, Object> properties = new HashMap<>();
        userProvidedServiceAppIDCfEnvProcessor.process(initUserProvidedService().getCredentials(), properties);
        assertThat(properties.size()).isEqualTo(3);
    ...
    @Test
    public void validUserProvidedService_getProperties_correctServiceNameAndPrefixes() {
        assertThat(userProvidedServiceAppIDCfEnvProcessor.getProperties().getServiceName()).isEqualTo("AppID");
        assertThat(userProvidedServiceAppIDCfEnvProcessor.getProperties().getPropertyPrefixes()).isEqualTo("spring.security.oauth2.client.registration.appid");
    }
}
