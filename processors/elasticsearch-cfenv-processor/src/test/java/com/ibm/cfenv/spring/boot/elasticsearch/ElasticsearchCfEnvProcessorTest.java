...
class ElasticsearchCfEnvProcessorTest {
    ...
    public void validCFService_propertiesProcessed_CorrectElasticsearchSetup() throws IOException {
        ...
        assertThat(properties.get("spring.data.elasticsearch.client.reactive.username")).isEqualTo("elasticsearch_username");
        assertThat(properties.get("spring.data.elasticsearch.client.reactive.password")).isEqualTo("elasticsearch_password");
        assertThat(properties.get("spring.data.elasticsearch.client.reactive.endpoints")).isEqualTo("elasticsearch_host:30001");
        assertThat(properties.get("spring.elasticsearch.rest.username")).isEqualTo("elasticsearch_username");
        assertThat(properties.get("spring.elasticsearch.rest.password")).isEqualTo("elasticsearch_password");
        assertThat(properties.get("spring.elasticsearch.rest.uris")).isEqualTo("https://elasticsearch_host:30001");
