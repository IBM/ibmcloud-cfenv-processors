...
class AmqpCfEnvProcessorTest {
    ...
    public void validCFService_propertiesProcessed_CorrectSslSetup() {
        ...
        assertThat(properties.get("sslcontext.contexts.amqp.certificate")).isEqualTo("base_64_cert");
